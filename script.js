...
<img src="${(p.cover_image || "/images/blog/bienvenidos-xpertauth.jpg").replace(/^\//, "")}" alt="${esc(p.title)}" class="card-image">     
...
img.src = (src.replace(/^\//, "") || "images/blog/bienvenidos-xpertauth.jpg");          
        }
      },
      { once: true }
    );
